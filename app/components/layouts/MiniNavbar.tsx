    ...
    <CommonWrapper>
      <section className="flex items-center justify-between">
        <div className="cursor-pointer flex items-center gap-x-2">
          <Image src={CallIcon} alt="My Icon" width={15} height={15} />
          <p className="leading-[150%] text-sm">Phone +888 8888 888</p>
        </div>
        ...
        <div className="cursor-pointer flex items-center gap-x-2">
          <Image src={UserIcon} alt="My Icon" width={15} height={15} />
